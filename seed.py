...
DB_PATH = Path(__file__).resolve().parent / "instance" / "posts.db"
...
def seed():
    ...
    for i in range(120):
        ...
        content = content_template.replace("{topic}", title)
    ...
    db.close()
    print(f"{count}개의 샘플 데이터가 생성되었습니다.")
